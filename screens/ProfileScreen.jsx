import { View, Text, TouchableOpacity, Image,StyleSheet,Title , ScrollView } from "react-native";
          ...
          <ScrollView>
              ...
              <View style={styles.profileContainer}>
                <View style={styles.imgContainer}>
                    ...
                    <View style={styles.textContainer}>
                        <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>U Tun</Text>
                    </View>
                </View>
              </View>
            </SafeAreaView>
           ...
           <View style={tw`flex-1 justify-start mb-80`}>
            ...
            <View style={tw`flex-row`}>
             ...
             <Text style={tw`p-1 bg-white text-gray-700 rounded-2xl ml-23 mr-3 mb-3`}>U Tun Tun</Text>
             </View>
            ...
            <View style={tw`flex-row`}>
             ...
             <Text style={tw`p-1 bg-white text-gray-700 rounded-2xl ml-8 mr-3 mb-3`}>09423718997</Text>
             </View>
             <Svg height="20" width="300">
                <Line x1="0" y1="0" x2="300" y2="0" stroke="black" strokeWidth="2" />
            </Svg>
            ...
            <View style={tw`flex-row`}>
             ...
             <Text style={tw`p-1 bg-white text-gray-700 rounded-2xl ml-26 mr-3 mb-3`}>7/PaMaNa(N)238979</Text>
             </View>
             <Svg height="20" width="300">
                <Line x1="0" y1="0" x2="300" y2="0" stroke="black" strokeWidth="2" />
            </Svg>
            ...
            <Text style={tw`p-1 bg-white text-gray-700 rounded-2xl ml-11 mr-3 mb-3`}>3/444389</Text>
            </View>
            <Svg height="20" width="300">
                <Line x1="0" y1="0" x2="300" y2="0" stroke="black" strokeWidth="2" />
            </Svg>
            ...
            <View style={tw`flex-row`}>
             <Text style={tw`text-gray-700 ml-5 text-lg`}>TukTuk Plate No.</Text>
             {/* <Svg height="5" width="100">
                <Line x1="0" y1="0" x2="300" y2="0" stroke="black" strokeWidth="2" />
            </Svg> */}
            <Text style={tw`p-1 bg-white text-gray-700 rounded-2xl ml-5 mr-3 mb-3`}>11</Text>
            </View>
                ...
                >
                  <Text
                    style={tw`font-xl text-center text-white text-base`}
                  >
